...
const translations = {
  ...
  th: {
    title: "ระบบตรวจสอบโรคจากเล็บเบื้องต้น",
    upload: "ลากหรือเลือกภาพเล็บ",
    dropzone: "ลากภาพมาวางหรือคลิกเพื่อเลือกไฟล์ภาพ",
    run: "ตรวจสอบ",
    notice: "หมายเหตุ: ระบบนี้เป็นเพียงการคัดกรองเบื้องต้น อาจเกิดข้อผิดพลาดได้ ควรปรึกษาแพทย์ผู้เชี่ยวชาญเพื่อการวินิจฉัยที่ถูกต้องอีกครั้ง",
